...
class LinhaCardRemarcacaoWidget extends StatefulWidget {
  Remarcacao remarcacaoLista;

  LinhaCardRemarcacaoWidget(this.remarcacaoLista, {Key? key}) : super(key: key);

  @override
  State<LinhaCardRemarcacaoWidget> createState() =>
      _LinhaCardRemarcacaoWidgetState();
}

class _LinhaCardRemarcacaoWidgetState extends State<LinhaCardRemarcacaoWidget> {
